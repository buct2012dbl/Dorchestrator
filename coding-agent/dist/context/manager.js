...
(function (Priority) {
    ...
    Priority[Priority["P3"] = 3] = "P3";
    Priority[Priority["P4"] = 4] = "P4"; // Project structure overview
})(Priority || (Priority = {}));
export class ContextManager {
    cache = new Map();
    indexer = null;
    workingDirectory;
    constructor(workingDirectory, indexer) {
        this.workingDirectory = workingDirectory;
        this.indexer = indexer || null;
    }
    async buildContext(session, task, budget) {
        const allocated = {
            systemPrompt: 0,
            task: 0,
            files: 0,
    ...
    async selectRelevantFiles(task, session, budget) {
        const candidates = [];
